...
export const Info = () => {
    ...
    useEffect(() => {
        fetch("https://apis.scrimba.com/unsplash/photos/random?orientation=landscape&query=portrait+male")
        .then(res => res.json())
        .then(data => { 
            settasveer(data.urls.regular)
        })
    ...
    return (
        <div className="info">
            ...
            <div className="btns">
                <a className="btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 17 16" fill="none">
